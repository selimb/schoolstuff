    ...
    for(int i=0;i<nx-1;i++)
    {
        ...
        for(int k=0;k<3;k++)
            for(int i=0;i<nx-1;i++)
            {
                ...
                for(int j=0;j<3;j++)
                {
                    temp+=fabs(lambda[k][j])*(W[j][i+1]-W[j][i]);
                }
        ...
        if (i == 1 || i == 2 || i == 3) {
            ...
            std::cout << rho[i] << " " << U[i] << " " << c[i] << std::endl;
            for (int k = 0; k < 3; k++) {
                std::cout << eigenvalueH[k] << "  ";
            }
            std::cout << std::endl;
            for (int k = 0; k < 3; k++) {
                std::cout << Flux[k][i] << "  ";
...
//		printf("%f\n",Flux[1][i]);
        ...
        for(int k=0;k<3;k++)
        {
            for(int i=0;i<nx;i++)
            {
                Resi[k][i+1]=Flux[k][i+1]*S_edge[i+1]-Flux[k][i]*S_edge[i]-Q[k][i+1];
            }
            Resi[k][0]=0;
            Resi[k][nx-1]=0;
        }
//      std::cout << "s2" << std::endl;
//      std::cout << S_edge[2] << std::endl;
//      std::cout << "s3" << std::endl;
//      std::cout << S_edge[3] << std::endl;
//      std::cout << "flux2" << std::endl;
...
//          std::cout << Flux[k][2] << "  ";
//      }
//      std::cout << "flux3" << std::endl;
//      for(int k=0;k<3;k++)
//      {
//          std::cout << Flux[k][3] << "  ";
//      }
//      std::cout << "resi2" << std::endl;
        for(int k=0;k<3;k++)
        {
            std::cout << Resi[k][2] << " ";
        }
